...
const messages = {
    en: {
        ...
        home: { emergencySOS: "Emergency SOS", emergencySOSDes:"Instant alert system for safety concerns", liveTracking:"Live Tracking", liveTrackingDes: "Track helper location during active jobs", securePayment: "Secure Payments", ecurePaymentDes: "Escrow-based payment system for your protection", securePaymentsDes: "Escrow-based payment system for your protection", verifiedHelpers: "Verified Helpers",verifiedHelpersDes: "All helpers undergo ID and background verification", heroTitle: "Find Trusted Help\nFor Every Moment", heroSubtitle: "Connect with verified helpers for events, errands, elder care, and more", becomeHelper: "Become a Helper", popularCategories: "Popular Categories", helpersAvailable: "{count} helpers available", topRated: "Top Rated Helpers", trusted: "Verified professionals trusted by thousands", whyChoose: "Why Choose TimeBuddy?", ready: "Ready to Get Started?", join: "Join thousands of satisfied customers and helpers", signUpNow: "Sign Up Now", welcomeBack: "Welcome back!", loggedInPrompt: "Pick up where you left off and manage your TimeBuddy activity.", goToDashboard: "Go to dashboard", footerDescription: "TimeBuddy makes it simple to find trusted help for the moments that matter.", quickLinks: "Quick links", contactUs: "Contact us", needHelp: "Need help or have a question?", rightsReserved: "All rights reserved." },
    ...
    hi: {
        ...
        home: {  emergencySOS: "इमरजेंसी SOS", emergencySOSDes:"सुरक्षा से जुड़ी चिंताओं के लिए तुरंत अलर्ट करने वाला सिस्टम", liveTracking:"लाइव ट्रैकिंग", liveTrackingDes: "एक्टिव जॉब्स के दौरान हेल्पर की लोकेशन ट्रैक करें", securePayment: "सुरक्षित भुगतान", securePaymentDes:"आपकी सुरक्षा के लिए एस्क्रो-आधारित पेमेंट सिस्टम", securePaymentsDes:"आपकी सुरक्षा के लिए एस्क्रो-आधारित पेमेंट सिस्टम", verifiedHelpers: "सत्यापित मददगार", verifiedHelpersDes: "सभी हेल्पर्स की ID और बैकग्राउंड की जाँच की जाती है।", heroTitle: "हर पल के लिए\nविश्वसनीय सहायता खोजें", heroSubtitle: "कार्यक्रमों, काम-काज, बुज़ुर्गों की देखभाल और अन्य सेवाओं के लिए सत्यापित सहायकों से जुड़ें", becomeHelper: "सहायक बनें", popularCategories: "लोकप्रिय श्रेणियाँ", helpersAvailable: "{count} सहायक उपलब्ध हैं", topRated: "सर्वश्रेष्ठ रेटेड सहायक", trusted: "हजारों लोगों के विश्वसनीय सत्यापित पेशेवर", whyChoose: "TimeBuddy क्यों चुनें?", ready: "शुरू करने के लिए तैयार हैं?", join: "हजारों संतुष्ट ग्राहकों और सहायकों से जुड़ें", signUpNow: "अभी साइन अप करें", welcomeBack: "वापसी पर स्वागत है!", loggedInPrompt: "जहाँ छोड़ा था वहीं से शुरू करें और अपनी TimeBuddy गतिविधि प्रबंधित करें।", goToDashboard: "डैशबोर्ड पर जाएँ", footerDescription: "TimeBuddy महत्वपूर्ण पलों के लिए विश्वसनीय सहायता खोजना आसान बनाता है।", quickLinks: "त्वरित लिंक", contactUs: "संपर्क करें", needHelp: "मदद चाहिए या कोई सवाल है?", rightsReserved: "सर्वाधिकार सुरक्षित।" },
