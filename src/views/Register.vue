        ...
        <div class="max-w-md w-full">
            <div class="card">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 mt-2">{{ t("auth.joinToday") }}</p>
                </div>
                ...
                <form @submit.prevent="handleRegister" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button type="button" @click="form.role = 'customer'" :class="[
                                ...
                                <div class="font-medium">{{ t("auth.findHelp") }}</div>
                            </button>
                            <button type="button" @click="form.role = 'helper'" :class="[
                                'p-4 rounded-lg border-2 transition-all',
                                form.role === 'helper'
                                    ? 'border-primary-500 bg-primary-50'
                                    : 'border-gray-200 hover:border-gray-300',
                                ...
                                <div class="text-2xl mb-2">🙋</div>
                                <div class="font-medium">{{ t("auth.offerHelp") }}</div>
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input v-model="form.phone" type="tel" required class="input" placeholder="+91 98765 43210" />
                    </div>
                    ...
                    <div>
                        <label class="flex items-start">
                            <input v-model="form_valid.agreeToTerms" type="checkbox" required
